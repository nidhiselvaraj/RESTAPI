...
public class Userstable {
   ...
   //One to Many
   @PostMapping("addcustomm")
	public List<Usertablemodel> addi(@RequestBody List<Usertablemodel> ss)
	{
		return (List<Usertablemodel>)srs.savein(ss);
	}
	@GetMapping("getcustomm")
	public List<Usertablemodel> geti()
	{
		return srs.showin();
   }	
}
