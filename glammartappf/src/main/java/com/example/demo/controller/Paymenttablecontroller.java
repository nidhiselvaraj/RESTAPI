...
public class Paymenttablecontroller {
	...
	//One to one mapping
	@PostMapping("addcustoone")
	public Paymenttablemodel addone(@RequestBody Paymenttablemodel ss)
	{
		return sr.saveinfoone(ss);
	} 
	@GetMapping("getcustoone")
	public List<Paymenttablemodel> getone()
	{
		return sr.showinfoone();
    }
}
